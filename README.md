...
**[TDD]** In this project I implement a class with some methods by doing test-driven development (TDD). I wrote tests first and then the code.
...
```sh
  cd my-folder
  git clone git@github.com:Sonickmumba/TDD.git
